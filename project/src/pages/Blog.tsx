            ...
            <div className="space-y-6">
              {posts.length === 0 ? (
                ...
                posts.map((post) => (
                  <article 
                    key={post.id} 
                    className="p-6 bg-black hover:shadow-2xl hover:shadow-blue-500/10 hover:-translate-y-1 hover:border-gray-600 transition-all duration-300 cursor-pointer group"
